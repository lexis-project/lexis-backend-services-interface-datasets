...
func (o *CheckDeletionStatusOK) Error() string {
	return fmt.Sprintf("[GET /staging/delete/{request_id}][%d] checkDeletionStatusOK  %+v", 200, o.Payload)
}
...
func (o *CheckDeletionStatusBadRequest) Error() string {
	return fmt.Sprintf("[GET /staging/delete/{request_id}][%d] checkDeletionStatusBadRequest  %+v", 400, o.Payload)
}
...
func (o *CheckDeletionStatusUnauthorized) Error() string {
	return fmt.Sprintf("[GET /staging/delete/{request_id}][%d] checkDeletionStatusUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CheckDeletionStatusNotFound) Error() string {
	return fmt.Sprintf("[GET /staging/delete/{request_id}][%d] checkDeletionStatusNotFound  %+v", 404, o.Payload)
}
...
func (o *CheckDeletionStatusRequestURITooLong) Error() string {
	return fmt.Sprintf("[GET /staging/delete/{request_id}][%d] checkDeletionStatusRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *CheckDeletionStatusInternalServerError) Error() string {
	return fmt.Sprintf("[GET /staging/delete/{request_id}][%d] checkDeletionStatusInternalServerError  %+v", 500, o.Payload)
}
