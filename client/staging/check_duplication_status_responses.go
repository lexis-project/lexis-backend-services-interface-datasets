...
func (o *CheckDuplicationStatusOK) Error() string {
	return fmt.Sprintf("[GET /staging/duplicate/{request_id}][%d] checkDuplicationStatusOK  %+v", 200, o.Payload)
}
...
func (o *CheckDuplicationStatusBadRequest) Error() string {
	return fmt.Sprintf("[GET /staging/duplicate/{request_id}][%d] checkDuplicationStatusBadRequest  %+v", 400, o.Payload)
}
...
func (o *CheckDuplicationStatusUnauthorized) Error() string {
	return fmt.Sprintf("[GET /staging/duplicate/{request_id}][%d] checkDuplicationStatusUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CheckDuplicationStatusNotFound) Error() string {
	return fmt.Sprintf("[GET /staging/duplicate/{request_id}][%d] checkDuplicationStatusNotFound  %+v", 404, o.Payload)
}
...
func (o *CheckDuplicationStatusRequestURITooLong) Error() string {
	return fmt.Sprintf("[GET /staging/duplicate/{request_id}][%d] checkDuplicationStatusRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *CheckDuplicationStatusInternalServerError) Error() string {
	return fmt.Sprintf("[GET /staging/duplicate/{request_id}][%d] checkDuplicationStatusInternalServerError  %+v", 500, o.Payload)
}
