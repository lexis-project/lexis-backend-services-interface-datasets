...
func (o *StageCreated) Error() string {
	return fmt.Sprintf("[POST /staging/stage][%d] stageCreated  %+v", 201, o.Payload)
}

func (o *StageCreated) GetPayload() *models.RequestID {
	return o.Payload
}
...
func (o *StageBadRequest) Error() string {
	return fmt.Sprintf("[POST /staging/stage][%d] stageBadRequest  %+v", 400, o.Payload)
}
...
func (o *StageUnauthorized) Error() string {
	return fmt.Sprintf("[POST /staging/stage][%d] stageUnauthorized  %+v", 401, o.Payload)
}
...
func (o *StageForbidden) Error() string {
	return fmt.Sprintf("[POST /staging/stage][%d] stageForbidden  %+v", 403, o.Payload)
}
...
func (o *StageNotFound) Error() string {
	return fmt.Sprintf("[POST /staging/stage][%d] stageNotFound  %+v", 404, o.Payload)
}
...
func (o *StageRequestURITooLong) Error() string {
	return fmt.Sprintf("[POST /staging/stage][%d] stageRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *StageTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /staging/stage][%d] stageTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *StageInternalServerError) Error() string {
	return fmt.Sprintf("[POST /staging/stage][%d] stageInternalServerError  %+v", 500, o.Payload)
}
