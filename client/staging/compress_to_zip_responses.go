...
func (o *CompressToZipCreated) Error() string {
	return fmt.Sprintf("[POST /compress/zip][%d] compressToZipCreated  %+v", 201, o.Payload)
}

func (o *CompressToZipCreated) GetPayload() *models.RequestID {
	return o.Payload
}
...
func (o *CompressToZipBadRequest) Error() string {
	return fmt.Sprintf("[POST /compress/zip][%d] compressToZipBadRequest  %+v", 400, o.Payload)
}
...
func (o *CompressToZipUnauthorized) Error() string {
	return fmt.Sprintf("[POST /compress/zip][%d] compressToZipUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CompressToZipForbidden) Error() string {
	return fmt.Sprintf("[POST /compress/zip][%d] compressToZipForbidden  %+v", 403, o.Payload)
}
...
func (o *CompressToZipBadGateway) Error() string {
	return fmt.Sprintf("[POST /compress/zip][%d] compressToZipBadGateway  %+v", 502, o.Payload)
}
...
func (o *CompressToZipServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /compress/zip][%d] compressToZipServiceUnavailable  %+v", 503, o.Payload)
}
