...
func (o *CloudNFSExportAddCreated) Error() string {
	return fmt.Sprintf("[POST /cloud/add/{param}][%d] cloudNFSExportAddCreated  %+v", 201, o.Payload)
}

func (o *CloudNFSExportAddCreated) GetPayload() *models.RequestID {
	return o.Payload
}
...
func (o *CloudNFSExportAddBadRequest) Error() string {
	return fmt.Sprintf("[POST /cloud/add/{param}][%d] cloudNFSExportAddBadRequest  %+v", 400, o.Payload)
}
...
func (o *CloudNFSExportAddUnauthorized) Error() string {
	return fmt.Sprintf("[POST /cloud/add/{param}][%d] cloudNFSExportAddUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CloudNFSExportAddForbidden) Error() string {
	return fmt.Sprintf("[POST /cloud/add/{param}][%d] cloudNFSExportAddForbidden  %+v", 403, o.Payload)
}
...
func (o *CloudNFSExportAddRequestURITooLong) Error() string {
	return fmt.Sprintf("[POST /cloud/add/{param}][%d] cloudNFSExportAddRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *CloudNFSExportAddInternalServerError) Error() string {
	return fmt.Sprintf("[POST /cloud/add/{param}][%d] cloudNFSExportAddInternalServerError  %+v", 500, o.Payload)
}
