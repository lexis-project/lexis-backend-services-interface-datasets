...
func (o *DeleteCreated) Error() string {
	return fmt.Sprintf("[DELETE /staging/delete][%d] deleteCreated  %+v", 201, o.Payload)
}

func (o *DeleteCreated) GetPayload() *models.RequestID {
	return o.Payload
}
...
func (o *DeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /staging/delete][%d] deleteBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /staging/delete][%d] deleteUnauthorized  %+v", 401, o.Payload)
}
...
func (o *DeleteForbidden) Error() string {
	return fmt.Sprintf("[DELETE /staging/delete][%d] deleteForbidden  %+v", 403, o.Payload)
}
...
func (o *DeleteNotFound) Error() string {
	return fmt.Sprintf("[DELETE /staging/delete][%d] deleteNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteRequestURITooLong) Error() string {
	return fmt.Sprintf("[DELETE /staging/delete][%d] deleteRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *DeleteTooManyRequests) Error() string {
	return fmt.Sprintf("[DELETE /staging/delete][%d] deleteTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *DeleteInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /staging/delete][%d] deleteInternalServerError  %+v", 500, o.Payload)
}
