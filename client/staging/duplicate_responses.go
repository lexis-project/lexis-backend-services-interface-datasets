...
func (o *DuplicateCreated) Error() string {
	return fmt.Sprintf("[POST /staging/duplicate][%d] duplicateCreated  %+v", 201, o.Payload)
}

func (o *DuplicateCreated) GetPayload() *models.RequestID {
	return o.Payload
}
...
func (o *DuplicateBadRequest) Error() string {
	return fmt.Sprintf("[POST /staging/duplicate][%d] duplicateBadRequest  %+v", 400, o.Payload)
}
...
func (o *DuplicateUnauthorized) Error() string {
	return fmt.Sprintf("[POST /staging/duplicate][%d] duplicateUnauthorized  %+v", 401, o.Payload)
}
...
func (o *DuplicateForbidden) Error() string {
	return fmt.Sprintf("[POST /staging/duplicate][%d] duplicateForbidden  %+v", 403, o.Payload)
}
...
func (o *DuplicateNotFound) Error() string {
	return fmt.Sprintf("[POST /staging/duplicate][%d] duplicateNotFound  %+v", 404, o.Payload)
}
...
func (o *DuplicateRequestURITooLong) Error() string {
	return fmt.Sprintf("[POST /staging/duplicate][%d] duplicateRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *DuplicateTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /staging/duplicate][%d] duplicateTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *DuplicateInternalServerError) Error() string {
	return fmt.Sprintf("[POST /staging/duplicate][%d] duplicateInternalServerError  %+v", 500, o.Payload)
}
