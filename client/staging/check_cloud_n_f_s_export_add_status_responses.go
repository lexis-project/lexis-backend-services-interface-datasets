...
func (o *CheckCloudNFSExportAddStatusOK) Error() string {
	return fmt.Sprintf("[GET /cloud/add/{param}][%d] checkCloudNFSExportAddStatusOK  %+v", 200, o.Payload)
}
...
func (o *CheckCloudNFSExportAddStatusBadRequest) Error() string {
	return fmt.Sprintf("[GET /cloud/add/{param}][%d] checkCloudNFSExportAddStatusBadRequest  %+v", 400, o.Payload)
}
...
func (o *CheckCloudNFSExportAddStatusUnauthorized) Error() string {
	return fmt.Sprintf("[GET /cloud/add/{param}][%d] checkCloudNFSExportAddStatusUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CheckCloudNFSExportAddStatusForbidden) Error() string {
	return fmt.Sprintf("[GET /cloud/add/{param}][%d] checkCloudNFSExportAddStatusForbidden  %+v", 403, o.Payload)
}
...
func (o *CheckCloudNFSExportAddStatusNotFound) Error() string {
	return fmt.Sprintf("[GET /cloud/add/{param}][%d] checkCloudNFSExportAddStatusNotFound  %+v", 404, o.Payload)
}
...
func (o *CheckCloudNFSExportAddStatusRequestURITooLong) Error() string {
	return fmt.Sprintf("[GET /cloud/add/{param}][%d] checkCloudNFSExportAddStatusRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *CheckCloudNFSExportAddStatusInternalServerError) Error() string {
	return fmt.Sprintf("[GET /cloud/add/{param}][%d] checkCloudNFSExportAddStatusInternalServerError  %+v", 500, o.Payload)
}
