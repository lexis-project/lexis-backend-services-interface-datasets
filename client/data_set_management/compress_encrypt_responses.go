...
func (o *CompressEncryptCreated) Error() string {
	return fmt.Sprintf("[POST /encryption/compress_encrypt][%d] compressEncryptCreated  %+v", 201, o.Payload)
}

func (o *CompressEncryptCreated) GetPayload() *models.RequestID {
	return o.Payload
}
...
func (o *CompressEncryptBadRequest) Error() string {
	return fmt.Sprintf("[POST /encryption/compress_encrypt][%d] compressEncryptBadRequest  %+v", 400, o.Payload)
}
...
func (o *CompressEncryptUnauthorized) Error() string {
	return fmt.Sprintf("[POST /encryption/compress_encrypt][%d] compressEncryptUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CompressEncryptForbidden) Error() string {
	return fmt.Sprintf("[POST /encryption/compress_encrypt][%d] compressEncryptForbidden  %+v", 403, o.Payload)
}
...
func (o *CompressEncryptNotFound) Error() string {
	return fmt.Sprintf("[POST /encryption/compress_encrypt][%d] compressEncryptNotFound  %+v", 404, o.Payload)
}
...
func (o *CompressEncryptRequestURITooLong) Error() string {
	return fmt.Sprintf("[POST /encryption/compress_encrypt][%d] compressEncryptRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *CompressEncryptTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /encryption/compress_encrypt][%d] compressEncryptTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *CompressEncryptInternalServerError) Error() string {
	return fmt.Sprintf("[POST /encryption/compress_encrypt][%d] compressEncryptInternalServerError  %+v", 500, o.Payload)
}
