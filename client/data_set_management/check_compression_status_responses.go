...
func (o *CheckCompressionStatusOK) Error() string {
	return fmt.Sprintf("[GET /encryption/compress/{request_id}][%d] checkCompressionStatusOK  %+v", 200, o.Payload)
}
...
func (o *CheckCompressionStatusBadRequest) Error() string {
	return fmt.Sprintf("[GET /encryption/compress/{request_id}][%d] checkCompressionStatusBadRequest  %+v", 400, o.Payload)
}
...
func (o *CheckCompressionStatusUnauthorized) Error() string {
	return fmt.Sprintf("[GET /encryption/compress/{request_id}][%d] checkCompressionStatusUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CheckCompressionStatusNotFound) Error() string {
	return fmt.Sprintf("[GET /encryption/compress/{request_id}][%d] checkCompressionStatusNotFound  %+v", 404, o.Payload)
}
...
func (o *CheckCompressionStatusRequestURITooLong) Error() string {
	return fmt.Sprintf("[GET /encryption/compress/{request_id}][%d] checkCompressionStatusRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *CheckCompressionStatusInternalServerError) Error() string {
	return fmt.Sprintf("[GET /encryption/compress/{request_id}][%d] checkCompressionStatusInternalServerError  %+v", 500, o.Payload)
}
