...
type API interface {
	...
	/*
	   AddProjectAdmin adds an administrator user to a project in i r o d s w p3 d d i

	   Add an administrator user to a project in iRODS WP3 DDI*/
	AddProjectAdmin(ctx context.Context, params *AddProjectAdminParams) (*AddProjectAdminCreated, error)
	/*
	   AddProjectUser adds a user to a project in i r o d s w p3 d d i

	   Add a user to a project in iRODS WP3 DDI*/
	AddProjectUser(ctx context.Context, params *AddProjectUserParams) (*AddProjectUserCreated, error)
	/*
	   AddSupportUser adds a user to a support duties in i r o d s w p3 d d i

	   Add a user to a support duties in iRODS WP3 DDI*/
	AddSupportUser(ctx context.Context, params *AddSupportUserParams) (*AddSupportUserCreated, error)
	/*
	...
	/*
	   CreateProject creates a project in i r o d s w p3 d d i
	...
	/*
	   CreateUser creates a user in i r o d s w p3 d d i and connect to keycloak
	...
	*/
	...
	/*
	   DeleteProject deletes a project in i r o d s w p3 d d i
	...
	/*
	   DeleteProjectAdmin removes user from project in i r o d s w p3 d d i

	   Remove user from project in iRODS WP3 DDI*/
	DeleteProjectAdmin(ctx context.Context, params *DeleteProjectAdminParams) (*DeleteProjectAdminNoContent, error)
	/*
	   DeleteProjectUser removes user from project in i r o d s w p3 d d i

	   Remove user from project in iRODS WP3 DDI*/
	DeleteProjectUser(ctx context.Context, params *DeleteProjectUserParams) (*DeleteProjectUserNoContent, error)
	/*
	...
	/*
	   DeleteSupportUser removes user from support duties in i r o d s w p3 d d i

	   Remove user from support duties in iRODS WP3 DDI*/
	DeleteSupportUser(ctx context.Context, params *DeleteSupportUserParams) (*DeleteSupportUserNoContent, error)
	/*
	   DeleteUser deletes a user in i r o d s w p3 d d i
	...
	/*
	   PostStagingDownload downloads from staging zone

	   Download from staging zone*/
	PostStagingDownload(ctx context.Context, params *PostStagingDownloadParams, writer io.Writer) (*PostStagingDownloadOK, error)
	/*
...
Add an administrator user to a project in iRODS WP3 DDI
*/
func (a *Client) AddProjectAdmin(ctx context.Context, params *AddProjectAdminParams) (*AddProjectAdminCreated, error) {

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "AddProjectAdmin",
		Method:             "POST",
		PathPattern:        "/project/admin",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &AddProjectAdminReader{formats: a.formats},
		AuthInfo:           a.authInfo,
		Context:            ctx,
		Client:             params.HTTPClient,
	})
	...
	return result.(*AddProjectAdminCreated), nil
...
Add a user to a project in iRODS WP3 DDI
*/
func (a *Client) AddProjectUser(ctx context.Context, params *AddProjectUserParams) (*AddProjectUserCreated, error) {

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "AddProjectUser",
		Method:             "POST",
		PathPattern:        "/project/user",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &AddProjectUserReader{formats: a.formats},
		AuthInfo:           a.authInfo,
		Context:            ctx,
		Client:             params.HTTPClient,
	})
	...
	return result.(*AddProjectUserCreated), nil
...
Add a user to a support duties in iRODS WP3 DDI
*/
func (a *Client) AddSupportUser(ctx context.Context, params *AddSupportUserParams) (*AddSupportUserCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &AddSupportUserReader{formats: a.formats},
		AuthInfo:           a.authInfo,
		Context:            ctx,
		Client:             params.HTTPClient,
	})
	...
	return result.(*AddSupportUserCreated), nil
...
func (a *Client) CheckCompressionEncryptionStatus(ctx context.Context, params *CheckCompressionEncryptionStatusParams) (*CheckCompressionEncryptionStatusOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/encryption/compress_encrypt/{request_id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
func (a *Client) CheckCompressionStatus(ctx context.Context, params *CheckCompressionStatusParams) (*CheckCompressionStatusOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/encryption/compress/{request_id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
func (a *Client) CheckDecompressionStatus(ctx context.Context, params *CheckDecompressionStatusParams) (*CheckDecompressionStatusOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/encryption/decompress/{request_id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
func (a *Client) CheckDecryptionDecompressionStatus(ctx context.Context, params *CheckDecryptionDecompressionStatusParams) (*CheckDecryptionDecompressionStatusOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/encryption/decrypt_decompress/{request_id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
func (a *Client) CheckDecryptionStatus(ctx context.Context, params *CheckDecryptionStatusParams) (*CheckDecryptionStatusOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/encryption/decrypt/{request_id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
func (a *Client) CheckEncryptionStatus(ctx context.Context, params *CheckEncryptionStatusParams) (*CheckEncryptionStatusOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/encryption/encrypt/{request_id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
func (a *Client) CheckReplicateStatus(ctx context.Context, params *CheckReplicateStatusParams) (*CheckReplicateStatusOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/replicate/{request_id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
func (a *Client) CheckSizeStatus(ctx context.Context, params *CheckSizeStatusParams) (*CheckSizeStatusOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "CheckSizeStatus",
		Method:             "GET",
		PathPattern:        "/data/size/{request_id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
func (a *Client) Compress(ctx context.Context, params *CompressParams) (*CompressCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "Compress",
		Method:             "POST",
		PathPattern:        "/encryption/compress",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
func (a *Client) CompressEncrypt(ctx context.Context, params *CompressEncryptParams) (*CompressEncryptCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "CompressEncrypt",
		Method:             "POST",
		PathPattern:        "/encryption/compress_encrypt",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
func (a *Client) Decompress(ctx context.Context, params *DecompressParams) (*DecompressCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "Decompress",
		Method:             "POST",
		PathPattern:        "/encryption/decompress",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
func (a *Client) DecryptDecompress(ctx context.Context, params *DecryptDecompressParams) (*DecryptDecompressCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "POST",
		PathPattern:        "/encryption/decrypt_decompress",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
Delete a project in iRODS WP3 DDI.
*/
func (a *Client) DeleteProject(ctx context.Context, params *DeleteProjectParams) (*DeleteProjectNoContent, error) {
...
Remove user from project in iRODS WP3 DDI
*/
func (a *Client) DeleteProjectAdmin(ctx context.Context, params *DeleteProjectAdminParams) (*DeleteProjectAdminNoContent, error) {

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "DeleteProjectAdmin",
		Method:             "DELETE",
		PathPattern:        "/project/admin",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &DeleteProjectAdminReader{formats: a.formats},
		AuthInfo:           a.authInfo,
		Context:            ctx,
		Client:             params.HTTPClient,
	})
	...
	return result.(*DeleteProjectAdminNoContent), nil
...
Remove user from project in iRODS WP3 DDI
*/
func (a *Client) DeleteProjectUser(ctx context.Context, params *DeleteProjectUserParams) (*DeleteProjectUserNoContent, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &DeleteProjectUserReader{formats: a.formats},
		AuthInfo:           a.authInfo,
		Context:            ctx,
		Client:             params.HTTPClient,
	})
	...
	return result.(*DeleteProjectUserNoContent), nil
...
Remove user from support duties in iRODS WP3 DDI
*/
func (a *Client) DeleteSupportUser(ctx context.Context, params *DeleteSupportUserParams) (*DeleteSupportUserNoContent, error) {

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "DeleteSupportUser",
		Method:             "DELETE",
		PathPattern:        "/support",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &DeleteSupportUserReader{formats: a.formats},
		AuthInfo:           a.authInfo,
		Context:            ctx,
		Client:             params.HTTPClient,
	})
	...
	return result.(*DeleteSupportUserNoContent), nil
...
Download from staging zone
*/
func (a *Client) PostStagingDownload(ctx context.Context, params *PostStagingDownloadParams, writer io.Writer) (*PostStagingDownloadOK, error) {

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PostStagingDownload",
		Method:             "POST",
		PathPattern:        "/staging/download",
		ProducesMediaTypes: []string{"application/json", "application/octet-stream"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &PostStagingDownloadReader{formats: a.formats, writer: writer},
		AuthInfo:           a.authInfo,
		Context:            ctx,
		Client:             params.HTTPClient,
	})
	...
	return result.(*PostStagingDownloadOK), nil
