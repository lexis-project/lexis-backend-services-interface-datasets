...
func (o *CreateDatasetOK) GetPayload() *models.ItemCreatedResponse {
	return o.Payload
}
...
func (o *CreateDatasetCreated) GetPayload() *models.ItemCreatedResponse {
	return o.Payload
}
...
type CreateDatasetBody struct {
	...
	// json-encoded file or zip (depending on compress_method)
	...
	// name of the file if compress_method is file
