...
// WithProjectInfo adds the projectInfo to the create project params
func (o *CreateProjectParams) WithProjectInfo(projectInfo CreateProjectBody) *CreateProjectParams {
	o.SetProjectInfo(projectInfo)
	return o
}

// SetProjectInfo adds the projectInfo to the create project params
func (o *CreateProjectParams) SetProjectInfo(projectInfo CreateProjectBody) {
