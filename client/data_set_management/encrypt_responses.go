...
func (o *EncryptCreated) Error() string {
	return fmt.Sprintf("[POST /encryption/encrypt][%d] encryptCreated  %+v", 201, o.Payload)
}

func (o *EncryptCreated) GetPayload() *models.RequestID {
	return o.Payload
}
...
func (o *EncryptBadRequest) Error() string {
	return fmt.Sprintf("[POST /encryption/encrypt][%d] encryptBadRequest  %+v", 400, o.Payload)
}
...
func (o *EncryptUnauthorized) Error() string {
	return fmt.Sprintf("[POST /encryption/encrypt][%d] encryptUnauthorized  %+v", 401, o.Payload)
}
...
func (o *EncryptForbidden) Error() string {
	return fmt.Sprintf("[POST /encryption/encrypt][%d] encryptForbidden  %+v", 403, o.Payload)
}
...
func (o *EncryptNotFound) Error() string {
	return fmt.Sprintf("[POST /encryption/encrypt][%d] encryptNotFound  %+v", 404, o.Payload)
}
...
func (o *EncryptRequestURITooLong) Error() string {
	return fmt.Sprintf("[POST /encryption/encrypt][%d] encryptRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *EncryptTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /encryption/encrypt][%d] encryptTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *EncryptInternalServerError) Error() string {
	return fmt.Sprintf("[POST /encryption/encrypt][%d] encryptInternalServerError  %+v", 500, o.Payload)
}
