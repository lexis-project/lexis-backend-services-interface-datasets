...
func (o *CheckSizeStatusOK) Error() string {
	return fmt.Sprintf("[GET /data/size/{request_id}][%d] checkSizeStatusOK  %+v", 200, o.Payload)
}
...
func (o *CheckSizeStatusBadRequest) Error() string {
	return fmt.Sprintf("[GET /data/size/{request_id}][%d] checkSizeStatusBadRequest  %+v", 400, o.Payload)
}
...
func (o *CheckSizeStatusUnauthorized) Error() string {
	return fmt.Sprintf("[GET /data/size/{request_id}][%d] checkSizeStatusUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CheckSizeStatusForbidden) Error() string {
	return fmt.Sprintf("[GET /data/size/{request_id}][%d] checkSizeStatusForbidden  %+v", 403, o.Payload)
}
...
func (o *CheckSizeStatusNotFound) Error() string {
	return fmt.Sprintf("[GET /data/size/{request_id}][%d] checkSizeStatusNotFound  %+v", 404, o.Payload)
}
...
func (o *CheckSizeStatusRequestURITooLong) Error() string {
	return fmt.Sprintf("[GET /data/size/{request_id}][%d] checkSizeStatusRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *CheckSizeStatusTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /data/size/{request_id}][%d] checkSizeStatusTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *CheckSizeStatusInternalServerError) Error() string {
	return fmt.Sprintf("[GET /data/size/{request_id}][%d] checkSizeStatusInternalServerError  %+v", 500, o.Payload)
}
