...
func (o *DecompressCreated) Error() string {
	return fmt.Sprintf("[POST /encryption/decompress][%d] decompressCreated  %+v", 201, o.Payload)
}

func (o *DecompressCreated) GetPayload() *models.RequestID {
	return o.Payload
}
...
func (o *DecompressBadRequest) Error() string {
	return fmt.Sprintf("[POST /encryption/decompress][%d] decompressBadRequest  %+v", 400, o.Payload)
}
...
func (o *DecompressUnauthorized) Error() string {
	return fmt.Sprintf("[POST /encryption/decompress][%d] decompressUnauthorized  %+v", 401, o.Payload)
}
...
func (o *DecompressForbidden) Error() string {
	return fmt.Sprintf("[POST /encryption/decompress][%d] decompressForbidden  %+v", 403, o.Payload)
}
...
func (o *DecompressNotFound) Error() string {
	return fmt.Sprintf("[POST /encryption/decompress][%d] decompressNotFound  %+v", 404, o.Payload)
}
...
func (o *DecompressRequestURITooLong) Error() string {
	return fmt.Sprintf("[POST /encryption/decompress][%d] decompressRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *DecompressTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /encryption/decompress][%d] decompressTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *DecompressInternalServerError) Error() string {
	return fmt.Sprintf("[POST /encryption/decompress][%d] decompressInternalServerError  %+v", 500, o.Payload)
}
