...
func (o *CreateSSHFSExportCreated) Error() string {
	return fmt.Sprintf("[POST /ssh/sshfsexport][%d] createSshFSExportCreated  %+v", 201, o.Payload)
}
...
func (o *CreateSSHFSExportBadRequest) Error() string {
	return fmt.Sprintf("[POST /ssh/sshfsexport][%d] createSshFSExportBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateSSHFSExportUnauthorized) Error() string {
	return fmt.Sprintf("[POST /ssh/sshfsexport][%d] createSshFSExportUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CreateSSHFSExportForbidden) Error() string {
	return fmt.Sprintf("[POST /ssh/sshfsexport][%d] createSshFSExportForbidden  %+v", 403, o.Payload)
}
...
func (o *CreateSSHFSExportServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /ssh/sshfsexport][%d] createSshFSExportServiceUnavailable  %+v", 503, o.Payload)
}
