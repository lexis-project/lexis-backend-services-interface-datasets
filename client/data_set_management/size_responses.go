...
func (o *SizeCreated) Error() string {
	return fmt.Sprintf("[POST /data/size][%d] sizeCreated  %+v", 201, o.Payload)
}

func (o *SizeCreated) GetPayload() *models.RequestID {
	return o.Payload
}
...
func (o *SizeBadRequest) Error() string {
	return fmt.Sprintf("[POST /data/size][%d] sizeBadRequest  %+v", 400, o.Payload)
}
...
func (o *SizeUnauthorized) Error() string {
	return fmt.Sprintf("[POST /data/size][%d] sizeUnauthorized  %+v", 401, o.Payload)
}
...
func (o *SizeForbidden) Error() string {
	return fmt.Sprintf("[POST /data/size][%d] sizeForbidden  %+v", 403, o.Payload)
}
...
func (o *SizeNotFound) Error() string {
	return fmt.Sprintf("[POST /data/size][%d] sizeNotFound  %+v", 404, o.Payload)
}
...
func (o *SizeRequestURITooLong) Error() string {
	return fmt.Sprintf("[POST /data/size][%d] sizeRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *SizeTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /data/size][%d] sizeTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *SizeInternalServerError) Error() string {
	return fmt.Sprintf("[POST /data/size][%d] sizeInternalServerError  %+v", 500, o.Payload)
}
