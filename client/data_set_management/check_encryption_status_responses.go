...
func (o *CheckEncryptionStatusOK) Error() string {
	return fmt.Sprintf("[GET /encryption/encrypt/{request_id}][%d] checkEncryptionStatusOK  %+v", 200, o.Payload)
}
...
func (o *CheckEncryptionStatusBadRequest) Error() string {
	return fmt.Sprintf("[GET /encryption/encrypt/{request_id}][%d] checkEncryptionStatusBadRequest  %+v", 400, o.Payload)
}
...
func (o *CheckEncryptionStatusUnauthorized) Error() string {
	return fmt.Sprintf("[GET /encryption/encrypt/{request_id}][%d] checkEncryptionStatusUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CheckEncryptionStatusNotFound) Error() string {
	return fmt.Sprintf("[GET /encryption/encrypt/{request_id}][%d] checkEncryptionStatusNotFound  %+v", 404, o.Payload)
}
...
func (o *CheckEncryptionStatusRequestURITooLong) Error() string {
	return fmt.Sprintf("[GET /encryption/encrypt/{request_id}][%d] checkEncryptionStatusRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *CheckEncryptionStatusInternalServerError) Error() string {
	return fmt.Sprintf("[GET /encryption/encrypt/{request_id}][%d] checkEncryptionStatusInternalServerError  %+v", 500, o.Payload)
}
