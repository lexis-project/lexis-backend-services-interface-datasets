...
func (o *CheckDecryptionStatusOK) Error() string {
	return fmt.Sprintf("[GET /encryption/decrypt/{request_id}][%d] checkDecryptionStatusOK  %+v", 200, o.Payload)
}
...
func (o *CheckDecryptionStatusBadRequest) Error() string {
	return fmt.Sprintf("[GET /encryption/decrypt/{request_id}][%d] checkDecryptionStatusBadRequest  %+v", 400, o.Payload)
}
...
func (o *CheckDecryptionStatusUnauthorized) Error() string {
	return fmt.Sprintf("[GET /encryption/decrypt/{request_id}][%d] checkDecryptionStatusUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CheckDecryptionStatusNotFound) Error() string {
	return fmt.Sprintf("[GET /encryption/decrypt/{request_id}][%d] checkDecryptionStatusNotFound  %+v", 404, o.Payload)
}
...
func (o *CheckDecryptionStatusRequestURITooLong) Error() string {
	return fmt.Sprintf("[GET /encryption/decrypt/{request_id}][%d] checkDecryptionStatusRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *CheckDecryptionStatusInternalServerError) Error() string {
	return fmt.Sprintf("[GET /encryption/decrypt/{request_id}][%d] checkDecryptionStatusInternalServerError  %+v", 500, o.Payload)
}
