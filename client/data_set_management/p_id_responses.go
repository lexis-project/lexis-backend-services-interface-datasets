...
func (o *PIDCreated) Error() string {
	return fmt.Sprintf("[POST /pid/assign][%d] pIdCreated  %+v", 201, o.Payload)
}

func (o *PIDCreated) GetPayload() *models.RequestID {
	return o.Payload
}
...
func (o *PIDBadRequest) Error() string {
	return fmt.Sprintf("[POST /pid/assign][%d] pIdBadRequest  %+v", 400, o.Payload)
}
...
func (o *PIDUnauthorized) Error() string {
	return fmt.Sprintf("[POST /pid/assign][%d] pIdUnauthorized  %+v", 401, o.Payload)
}
...
func (o *PIDForbidden) Error() string {
	return fmt.Sprintf("[POST /pid/assign][%d] pIdForbidden  %+v", 403, o.Payload)
}
...
func (o *PIDNotFound) Error() string {
	return fmt.Sprintf("[POST /pid/assign][%d] pIdNotFound  %+v", 404, o.Payload)
}
...
func (o *PIDRequestURITooLong) Error() string {
	return fmt.Sprintf("[POST /pid/assign][%d] pIdRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *PIDTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /pid/assign][%d] pIdTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *PIDInternalServerError) Error() string {
	return fmt.Sprintf("[POST /pid/assign][%d] pIdInternalServerError  %+v", 500, o.Payload)
}
