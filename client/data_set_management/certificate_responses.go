...
func (o *CertificateOK) Error() string {
	return fmt.Sprintf("[GET /cert][%d] certificateOK  %+v", 200, o.Payload)
}
...
func (o *CertificateUnauthorized) Error() string {
	return fmt.Sprintf("[GET /cert][%d] certificateUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CertificateInternalServerError) Error() string {
	return fmt.Sprintf("[GET /cert][%d] certificateInternalServerError  %+v", 500, o.Payload)
}
...
func (o *CertificateBadGateway) Error() string {
	return fmt.Sprintf("[GET /cert][%d] certificateBadGateway  %+v", 502, o.Payload)
}
...
func (o *CertificateServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /cert][%d] certificateServiceUnavailable  %+v", 503, o.Payload)
}
