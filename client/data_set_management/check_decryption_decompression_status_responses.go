...
func (o *CheckDecryptionDecompressionStatusOK) Error() string {
	return fmt.Sprintf("[GET /encryption/decrypt_decompress/{request_id}][%d] checkDecryptionDecompressionStatusOK  %+v", 200, o.Payload)
}
...
func (o *CheckDecryptionDecompressionStatusBadRequest) Error() string {
	return fmt.Sprintf("[GET /encryption/decrypt_decompress/{request_id}][%d] checkDecryptionDecompressionStatusBadRequest  %+v", 400, o.Payload)
}
...
func (o *CheckDecryptionDecompressionStatusUnauthorized) Error() string {
	return fmt.Sprintf("[GET /encryption/decrypt_decompress/{request_id}][%d] checkDecryptionDecompressionStatusUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CheckDecryptionDecompressionStatusNotFound) Error() string {
	return fmt.Sprintf("[GET /encryption/decrypt_decompress/{request_id}][%d] checkDecryptionDecompressionStatusNotFound  %+v", 404, o.Payload)
}
...
func (o *CheckDecryptionDecompressionStatusRequestURITooLong) Error() string {
	return fmt.Sprintf("[GET /encryption/decrypt_decompress/{request_id}][%d] checkDecryptionDecompressionStatusRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *CheckDecryptionDecompressionStatusInternalServerError) Error() string {
	return fmt.Sprintf("[GET /encryption/decrypt_decompress/{request_id}][%d] checkDecryptionDecompressionStatusInternalServerError  %+v", 500, o.Payload)
}
