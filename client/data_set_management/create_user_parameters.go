...
// WithUserInfo adds the userInfo to the create user params
func (o *CreateUserParams) WithUserInfo(userInfo CreateUserBody) *CreateUserParams {
	o.SetUserInfo(userInfo)
	return o
}

// SetUserInfo adds the userInfo to the create user params
func (o *CreateUserParams) SetUserInfo(userInfo CreateUserBody) {
	o.UserInfo = userInfo
}
