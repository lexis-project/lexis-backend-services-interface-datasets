...
func (o *ReplicateCreated) Error() string {
	return fmt.Sprintf("[POST /replicate][%d] replicateCreated  %+v", 201, o.Payload)
}

func (o *ReplicateCreated) GetPayload() *models.RequestID {
	return o.Payload
}
...
func (o *ReplicateBadRequest) Error() string {
	return fmt.Sprintf("[POST /replicate][%d] replicateBadRequest  %+v", 400, o.Payload)
}
...
func (o *ReplicateUnauthorized) Error() string {
	return fmt.Sprintf("[POST /replicate][%d] replicateUnauthorized  %+v", 401, o.Payload)
}
...
func (o *ReplicateForbidden) Error() string {
	return fmt.Sprintf("[POST /replicate][%d] replicateForbidden  %+v", 403, o.Payload)
}
...
func (o *ReplicateNotFound) Error() string {
	return fmt.Sprintf("[POST /replicate][%d] replicateNotFound  %+v", 404, o.Payload)
}
...
func (o *ReplicateRequestURITooLong) Error() string {
	return fmt.Sprintf("[POST /replicate][%d] replicateRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *ReplicateTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /replicate][%d] replicateTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *ReplicateInternalServerError) Error() string {
	return fmt.Sprintf("[POST /replicate][%d] replicateInternalServerError  %+v", 500, o.Payload)
}
