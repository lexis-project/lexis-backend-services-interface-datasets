...
func (o *CheckCompressionEncryptionStatusOK) Error() string {
	return fmt.Sprintf("[GET /encryption/compress_encrypt/{request_id}][%d] checkCompressionEncryptionStatusOK  %+v", 200, o.Payload)
}
...
func (o *CheckCompressionEncryptionStatusBadRequest) Error() string {
	return fmt.Sprintf("[GET /encryption/compress_encrypt/{request_id}][%d] checkCompressionEncryptionStatusBadRequest  %+v", 400, o.Payload)
}
...
func (o *CheckCompressionEncryptionStatusUnauthorized) Error() string {
	return fmt.Sprintf("[GET /encryption/compress_encrypt/{request_id}][%d] checkCompressionEncryptionStatusUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CheckCompressionEncryptionStatusNotFound) Error() string {
	return fmt.Sprintf("[GET /encryption/compress_encrypt/{request_id}][%d] checkCompressionEncryptionStatusNotFound  %+v", 404, o.Payload)
}
...
func (o *CheckCompressionEncryptionStatusRequestURITooLong) Error() string {
	return fmt.Sprintf("[GET /encryption/compress_encrypt/{request_id}][%d] checkCompressionEncryptionStatusRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *CheckCompressionEncryptionStatusInternalServerError) Error() string {
	return fmt.Sprintf("[GET /encryption/compress_encrypt/{request_id}][%d] checkCompressionEncryptionStatusInternalServerError  %+v", 500, o.Payload)
}
