...
func (o *DecryptDecompressCreated) Error() string {
	return fmt.Sprintf("[POST /encryption/decrypt_decompress][%d] decryptDecompressCreated  %+v", 201, o.Payload)
}

func (o *DecryptDecompressCreated) GetPayload() *models.RequestID {
	return o.Payload
}
...
func (o *DecryptDecompressBadRequest) Error() string {
	return fmt.Sprintf("[POST /encryption/decrypt_decompress][%d] decryptDecompressBadRequest  %+v", 400, o.Payload)
}
...
func (o *DecryptDecompressUnauthorized) Error() string {
	return fmt.Sprintf("[POST /encryption/decrypt_decompress][%d] decryptDecompressUnauthorized  %+v", 401, o.Payload)
}
...
func (o *DecryptDecompressForbidden) Error() string {
	return fmt.Sprintf("[POST /encryption/decrypt_decompress][%d] decryptDecompressForbidden  %+v", 403, o.Payload)
}
...
func (o *DecryptDecompressNotFound) Error() string {
	return fmt.Sprintf("[POST /encryption/decrypt_decompress][%d] decryptDecompressNotFound  %+v", 404, o.Payload)
}
...
func (o *DecryptDecompressRequestURITooLong) Error() string {
	return fmt.Sprintf("[POST /encryption/decrypt_decompress][%d] decryptDecompressRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *DecryptDecompressTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /encryption/decrypt_decompress][%d] decryptDecompressTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *DecryptDecompressInternalServerError) Error() string {
	return fmt.Sprintf("[POST /encryption/decrypt_decompress][%d] decryptDecompressInternalServerError  %+v", 500, o.Payload)
}
