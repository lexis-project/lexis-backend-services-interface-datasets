...
func (o *CheckReplicateStatusOK) Error() string {
	return fmt.Sprintf("[GET /replicate/{request_id}][%d] checkReplicateStatusOK  %+v", 200, o.Payload)
}
...
func (o *CheckReplicateStatusBadRequest) Error() string {
	return fmt.Sprintf("[GET /replicate/{request_id}][%d] checkReplicateStatusBadRequest  %+v", 400, o.Payload)
}
...
func (o *CheckReplicateStatusUnauthorized) Error() string {
	return fmt.Sprintf("[GET /replicate/{request_id}][%d] checkReplicateStatusUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CheckReplicateStatusForbidden) Error() string {
	return fmt.Sprintf("[GET /replicate/{request_id}][%d] checkReplicateStatusForbidden  %+v", 403, o.Payload)
}
...
func (o *CheckReplicateStatusNotFound) Error() string {
	return fmt.Sprintf("[GET /replicate/{request_id}][%d] checkReplicateStatusNotFound  %+v", 404, o.Payload)
}
...
func (o *CheckReplicateStatusRequestURITooLong) Error() string {
	return fmt.Sprintf("[GET /replicate/{request_id}][%d] checkReplicateStatusRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *CheckReplicateStatusTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /replicate/{request_id}][%d] checkReplicateStatusTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *CheckReplicateStatusInternalServerError) Error() string {
	return fmt.Sprintf("[GET /replicate/{request_id}][%d] checkReplicateStatusInternalServerError  %+v", 500, o.Payload)
}
