...
func (o *CheckPIDStatusOK) Error() string {
	return fmt.Sprintf("[GET /pid/{request_id}][%d] checkPIdStatusOK  %+v", 200, o.Payload)
}
...
func (o *CheckPIDStatusBadRequest) Error() string {
	return fmt.Sprintf("[GET /pid/{request_id}][%d] checkPIdStatusBadRequest  %+v", 400, o.Payload)
}
...
func (o *CheckPIDStatusUnauthorized) Error() string {
	return fmt.Sprintf("[GET /pid/{request_id}][%d] checkPIdStatusUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CheckPIDStatusForbidden) Error() string {
	return fmt.Sprintf("[GET /pid/{request_id}][%d] checkPIdStatusForbidden  %+v", 403, o.Payload)
}
...
func (o *CheckPIDStatusNotFound) Error() string {
	return fmt.Sprintf("[GET /pid/{request_id}][%d] checkPIdStatusNotFound  %+v", 404, o.Payload)
}
...
func (o *CheckPIDStatusRequestURITooLong) Error() string {
	return fmt.Sprintf("[GET /pid/{request_id}][%d] checkPIdStatusRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *CheckPIDStatusTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /pid/{request_id}][%d] checkPIdStatusTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *CheckPIDStatusInternalServerError) Error() string {
	return fmt.Sprintf("[GET /pid/{request_id}][%d] checkPIdStatusInternalServerError  %+v", 500, o.Payload)
}
