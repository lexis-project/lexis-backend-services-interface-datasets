...
func (o *CompressCreated) Error() string {
	return fmt.Sprintf("[POST /encryption/compress][%d] compressCreated  %+v", 201, o.Payload)
}

func (o *CompressCreated) GetPayload() *models.RequestID {
	return o.Payload
}
...
func (o *CompressBadRequest) Error() string {
	return fmt.Sprintf("[POST /encryption/compress][%d] compressBadRequest  %+v", 400, o.Payload)
}
...
func (o *CompressUnauthorized) Error() string {
	return fmt.Sprintf("[POST /encryption/compress][%d] compressUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CompressForbidden) Error() string {
	return fmt.Sprintf("[POST /encryption/compress][%d] compressForbidden  %+v", 403, o.Payload)
}
...
func (o *CompressNotFound) Error() string {
	return fmt.Sprintf("[POST /encryption/compress][%d] compressNotFound  %+v", 404, o.Payload)
}
...
func (o *CompressRequestURITooLong) Error() string {
	return fmt.Sprintf("[POST /encryption/compress][%d] compressRequestUriTooLong  %+v", 414, o.Payload)
}
...
func (o *CompressTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /encryption/compress][%d] compressTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *CompressInternalServerError) Error() string {
	return fmt.Sprintf("[POST /encryption/compress][%d] compressInternalServerError  %+v", 500, o.Payload)
}
