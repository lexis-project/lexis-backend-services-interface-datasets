...
type QueryDatasetsOK struct {
	...
	/*
	  In: Body
	*/
	Payload []*models.MetadataQueryResponse `json:"body,omitempty"`
}
...
func (o *QueryDatasetsOK) WithPayload(payload []*models.MetadataQueryResponse) *QueryDatasetsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the query datasets o k response
func (o *QueryDatasetsOK) SetPayload(payload []*models.MetadataQueryResponse) {
	o.Payload = payload
}
...
func (o *QueryDatasetsOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	if payload == nil {
		// return empty array
		payload = make([]*models.MetadataQueryResponse, 0, 50)
	}
