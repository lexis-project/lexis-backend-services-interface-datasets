...
func (o *CompressEncryptCreated) WithPayload(payload *models.RequestID) *CompressEncryptCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the compress encrypt created response
func (o *CompressEncryptCreated) SetPayload(payload *models.RequestID) {
	o.Payload = payload
}
