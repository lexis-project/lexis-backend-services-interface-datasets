...
func (o *DecryptDecompressCreated) WithPayload(payload *models.RequestID) *DecryptDecompressCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the decrypt decompress created response
func (o *DecryptDecompressCreated) SetPayload(payload *models.RequestID) {
	o.Payload = payload
}
