...
func (o *CreateDatasetOK) WithPayload(payload *models.ItemCreatedResponse) *CreateDatasetOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create dataset o k response
func (o *CreateDatasetOK) SetPayload(payload *models.ItemCreatedResponse) {
	o.Payload = payload
}
...
func (o *CreateDatasetCreated) WithPayload(payload *models.ItemCreatedResponse) *CreateDatasetCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create dataset created response
func (o *CreateDatasetCreated) SetPayload(payload *models.ItemCreatedResponse) {
	o.Payload = payload
}
