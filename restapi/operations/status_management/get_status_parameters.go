...
func (o *GetStatusParams) validateID(formats strfmt.Registry) error {
	...
	if err := validate.EnumCase("id", "path", o.ID, []interface{}{"status", "certificate", "cloudnfs", "compress", "datasetManager", "gridmap", "project", "replicate", "sshfs", "stagingDownload", "steering", "support", "tus", "user"}, true); err != nil {
		return err
	}
