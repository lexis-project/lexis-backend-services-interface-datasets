...
func (o *CloudNFSExportAddCreated) WithPayload(payload *models.RequestID) *CloudNFSExportAddCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the cloud n f s export add created response
func (o *CloudNFSExportAddCreated) SetPayload(payload *models.RequestID) {
	o.Payload = payload
}
