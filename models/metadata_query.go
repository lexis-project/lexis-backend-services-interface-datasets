...
// Validate validates this metadata query
func (m *MetadataQuery) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *MetadataQuery) validateAccess(formats strfmt.Registry) error {
...
func (m *MetadataQuery) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MetadataQuery) UnmarshalBinary(b []byte) error {
	var res MetadataQuery
